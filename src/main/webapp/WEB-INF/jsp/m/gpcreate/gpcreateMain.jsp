...
<html>
<head>
<c:set var="layout_type" value="gpcreate" scope="request" />
...
<body>
	<div class="content">
		...
		<div class="main-category">
			<ul>
				<li class="cate-item">
					<a href="${CTX}/product/productList.do?schCateIdx=74&schCateFlag=ALL" class="cate-link">
						<div class="cate-ico"><img src="${CTX}/images/${DEVICE}/main/ico_gpcreate_bath.png" alt="" /></div>
