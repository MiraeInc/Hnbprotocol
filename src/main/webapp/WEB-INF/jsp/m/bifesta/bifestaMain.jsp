...
<html>
<head>
<c:set var="layout_type" value="bifesta" scope="request" />
...
<body>
	<div class="content comm-main">
		...
		<div class="main-category">
			<ul>
				<li class="cate-item">
					<a href="${CTX}/product/productList.do?schCateIdx=29&schCateFlag=ALL" class="cate-link">
						<div class="cate-ico"><img src="${CTX}/images/${DEVICE}/main/ico_bifesta_sheet.png" alt="" /></div>
						<p class="cate-name">클렌징시트</p>
					</a>
				</li>
				<li class="cate-item">
					<a href="${CTX}/product/productList.do?schCateIdx=31&schCateFlag=ALL" class="cate-link">
						<div class="cate-ico"><img src="${CTX}/images/${DEVICE}/main/ico_bifesta_eye.png" alt="" /></div>
						<p class="cate-name">아이리무버</p>
					</a>
				</li>
				<li class="cate-item">
					<a href="${CTX}/product/productList.do?schCateIdx=28&schCateFlag=ALL" class="cate-link">
						<div class="cate-ico"><img src="${CTX}/images/${DEVICE}/main/ico_bifesta_water.png" alt="" /></div>
						<p class="cate-name">클렌징워터</p>
					</a>
				</li>
				<li class="cate-item"><%-- 카테고리 추가 --%>
					<a href="${CTX}/product/productList.do?schCateIdx=86&schCateFlag=ALL" class="cate-link">
						<div class="cate-ico"><img src="${CTX}/images/${DEVICE}/main/ico_bifesta_oil.png" alt="" /></div>
						<p class="cate-name">클렌징오일</p>
					</a>
				</li>
				<li class="cate-item">
					<a href="${CTX}/product/productList.do?schCateIdx=30&schCateFlag=ALL" class="cate-link">
						<div class="cate-ico"><img src="${CTX}/images/${DEVICE}/main/ico_bifesta_form.png" alt="" /></div>
						<p class="cate-name">클렌징폼</p>
					</a>
				</li>
				<li class="cate-item">
					<a href="${CTX}/product/productList.do?schCateIdx=27&schCateFlag=ALL" class="cate-link">
						<div class="cate-ico"><img src="${CTX}/images/${DEVICE}/main/ico_bifesta_set.png" alt="" /></div>
		...
		<c:if test="${!empty snsList}">
			<h2 class="look-title">BIFESTA LOOK</h2>
			<ul class="look-list">
		...
		<c:if test="${!empty setList}">
			<h2 class="set-title"><a href="${CTX}/product/productList.do?schCateIdx=27&schCateFlag=ALL">BIFESTA SET</a></h2>
			<div class="product-items nobor">
				<ul class="type-default">
		...
		<c:if test="${!empty tipList}">
			<h2 class="tips-title"><a href="${CTX}/style/tipList.do?brandIdx=3">STYLING TIPS</a></h2>
			<div class="tips-list">
		...
		<c:if test="${!empty bestList}">
			<h2 class="title"><a href="${CTX}/product/bestProductList.do?gnbBrand=bifesta&brandIdx=3">Mandom<br/>Best Product</a></h2>
