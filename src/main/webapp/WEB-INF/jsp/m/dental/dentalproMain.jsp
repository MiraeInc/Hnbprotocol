...
<html>
<head>
<c:set var="layout_type" value="dentalpro" scope="request" />
...
<body>
	<div class="content comm-main">
		...
		<div class="main-category">
			<ul>
				<li class="cate-item">
					<a href="${CTX}/product/productList.do?schCateIdx=53&schCateFlag=ALL" class="cate-link">
						<div class="cate-ico"><img src="${CTX}/images/${DEVICE}/main/ico_dental_tooth.png" alt="" /></div>
						<p class="cate-name">치간칫솔&nbsp;</p>
					</a>
				</li>
				<li class="cate-item">
					<a href="${CTX}/product/productList.do?schCateIdx=54&schCateFlag=ALL" class="cate-link">
						<div class="cate-ico" ><img src="${CTX}/images/${DEVICE}/main/ico_dental_tongue.png" alt="" /></div>
						<p class="cate-name" style="font-size: 14px">혀크리너/교정칫솔</p>
					</a>
				</li>
			</ul>
		</div>
		...
		<c:if test="${!empty bestList}">
			<h2 class="title"><a href="${CTX}/product/bestProductList.do?gnbBrand=dentalpro&brandIdx=7">Mandom<br/>Best Product</a></h2>
...
<c:forEach var="list" items="${popupList}" varStatus="idx" end="0">
	<c:if test="${list.dentalproYn eq '1'}">
