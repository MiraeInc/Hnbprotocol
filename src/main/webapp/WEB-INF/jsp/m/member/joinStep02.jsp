...
<script>
	...
	function termsCheck(){
        ...
        frm.action = "${CTX}/member/joinForm.do";
        frm.submit();
	}
					...
					<form name="joinStep02Form" method="post" onsubmit="return false">
						...
						<div class="form-group form-indent">
							<div class="form-custom">
								<input type="checkbox" id="serviceCheck" class="form-control" data-radio-check="temp1">
						...
						<div class="form-group form-indent">
							<div class="form-custom">
								<input type="checkbox" id="privacyCheck" class="form-control" data-radio-check="temp1">
									...
									<div class="terms">
										<div class="terms-row">
						                    ...
						                    <div class="terms-body" style="width: 70%;">
						                        <p>이름, 로그인 ID, 비밀번호, 성별, 이메일, 휴대폰번호, 주문기록 등 서비스이용기록</p>
						                    </div>
						                </div>
										...
										<div class="terms-row">
						                   ...
						                   <div class="terms-body" style="width: 70%;">
						                       ...
						                       <ul>
						                           <li>- 본인확인, 개인 식별, 불량회원의 부정 이용 방지와 비인가 사용 방지, 가입 의사 확인, 회원 관리, 불만처리 등 민원처리, 고지사항 전달</li>
						                           <li>서비스 제공에 관한 계약 이행 및 서비스 제공, 콘텐츠 제공</li>
						                       </ul>
						                   </div>
						               </div>
										...
										<div class="terms-row">
						                    ...
						                    <div class="terms-body" style="width: 70%;">
						                        <p style="text-decoration: underline; font-size: 0.75rem">관련 법령에 따라 고객님의 개인정보를 보존해야 하는 경우가 아닌 한, 고객님의 개인정보는 회원탈퇴 시까지 보유 및 이용됩니다. </p>
						                    </div>
						                </div>
										
										<div class="terms-row">
						                    <div class="terms-head">
						                        <p>동의거부권 및 거부 시 불이익</p>
						                    </div>
						                    <div class="terms-body" style="width: 70%;">
						                        <p>고객님께서는 개인정보 수집·이용 동의를 거부하실 수 있습니다. 다만 동의를 거부하실 경우 회원으로 가입하실 수 없을 수 있습니다.</p>
						                    </div>
						                </div>
									</div>
								</div>
						...
						<div class="form-group form-indent">
							<div class="form-custom">
								<input type="checkbox" id="marketingYn" class="form-control" data-radio-check="temp1">
								<label>개인정보 마케팅 목적 수집&middot;이용 동의 <span class="highlight">(선택)</span></label>
							</div>
						</div>
						<div class="textarea-box">
							<button class="textarea-btn" type="button"></button>
								...
								<div class="textarea-scroll">
									<div class="terms">
										<div class="terms-row">
						                    ...
						                    <div class="terms-body" style="width: 70%;">
						                        <p>이름, 이메일, 휴대폰번호, 주문기록 등 서비스이용기록, 생년월일, 가입경로</p>
						                    </div>
						                </div>
										...
										<div class="terms-row">
						                    ...
						                    <div class="terms-body" style="width: 70%;">
						                        <p style="text-decoration: underline; font-size: 0.688rem">
						                            회사는 수집한 정보를 SMS, MMS, 이메일, 알림톡 등을 통한 제품정보, 이벤트 등 광고성 정보의 전달 및 회원의 서비스 이용 향상 목적의 접속 빈도 분석 등 마케팅 통계 분석에 이용합니다.
						                        </p>
						                    </div>
						                </div>
										...
										<div class="terms-row">
						                    ...
						                    <div class="terms-body" style="width: 70%;">
						                        <p style="text-decoration: underline; font-size: 0.688rem">
						                            관련 법령에 따라 귀하의 개인정보를 보존해야 하는 경우가 아닌 한, 귀하의 개인정보는 회원탈퇴 시까지 보유 및 이용됩니다.
						                        </p>
						                    </div>
						                </div>
										...
										<div class="terms-row">
						                    ...
						                    <div class="terms-body" style="width: 70%;">
						                        <p>
						                            고객님께서는 개인정보 수집·이용 동의를 거부하실 수 있습니다. 다만 동의를 거부하실 경우 회사로부터 유용한 정보를 제공받지 못하실 수 있습니다.
						                        </p>
						                    </div>
						                </div>
									</div>
						...
						<div class="form-group form-indent">
							<div class="form-custom">
								<input type="checkbox" id="individualInfoYn" class="form-control" data-radio-check="temp1">
								<label>개인정보 마케팅 목적 위탁 동의 <span class="highlight">(선택)</span></label>
							</div>
						</div>
						<div class="textarea-box">
							<button class="textarea-btn" type="button"></button>
									...
									<div class="terms">
										<div class="terms-row">
											<div class="terms-body">
												<p>회사는 아래의 마케팅 업무를 위하여 고객님의 개인정보를 외부 수탁업체에 위탁합니다.</p>
											</div>
										</div>
						...
						<div class="button-group">
							<a href="javascript:" class="btn btn-black" onclick="termsCheck();">다음</a>
						</div>
					</form>
				</div>
			</div>
