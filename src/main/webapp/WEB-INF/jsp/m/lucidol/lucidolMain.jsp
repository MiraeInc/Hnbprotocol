...
<html>
<head>
<c:set var="layout_type" value="lucidol" scope="request" />
...
<body>
	<div class="content comm-main">
		...
		<div class="main-category">
			<ul>
				<li class="cate-item">
					<a href="${CTX}/product/productList.do?schCateIdx=34&schCateFlag=ALL" class="cate-link">
						<div class="cate-ico"><img src="${CTX}/images/${DEVICE}/main/ico_lucidol_care.png" alt="" /></div>
						<p class="cate-name">헤어케어</p>
					</a>
				</li>
				<li class="cate-item">
					<a href="${CTX}/product/productList.do?schCateIdx=35&schCateFlag=ALL" class="cate-link">
						<div class="cate-ico"><img src="${CTX}/images/${DEVICE}/main/ico_lucidol_style.png" alt="" /></div>
						<p class="cate-name">헤어스타일링</p>
					</a>
				</li>
				<li class="cate-item">
					<a href="${CTX}/product/productList.do?schCateIdx=39&schCateFlag=ALL" class="cate-link">
						<div class="cate-ico"><img src="${CTX}/images/${DEVICE}/main/ico_lucidol_set.png" alt="" /></div>
...
<%--
 ...
 --%>
		...
		<c:if test="${!empty snsList}">
			<h2 class="look-title">LUCIDO-L LOOK</h2>
			<ul class="look-list">
		...
		<c:if test="${!empty setList}">
			<h2 class="set-title"><a href="${CTX}/product/productList.do?schCateIdx=39&schCateFlag=ALL">LUCIDOL SET</a></h2>
			<div class="product-items nobor">
				<ul class="type-default">
		...
		<c:if test="${!empty tipList}">
			<h2 class="tips-title"><a href="${CTX}/style/tipList.do?brandIdx=4">STYLING TIPS</a></h2>
			<div class="tips-list">
		...
		<c:if test="${!empty bestList}">
			<h2 class="title"><a href="${CTX}/product/bestProductList.do?gnbBrand=lucidol&brandIdx=4">Mandom<br/>Best Product</a></h2>
