...
<meta name="menu_3depth" content="mypage_exchange" />
...
<script type="text/javascript">
	...
	function goSearch(){
		...
		frm.action="${CTX}/mypage/order/myExchangeList.do";
		frm.submit();
	}
			...
			<div class="content comm-order comm-mypage mypage-order">
				...
				<div class="page-filter">
					<ul>
						...
						<li><a href="${CTX}/mypage/order/myExchangeList.do"  class="active">교환 내역 (<fmt:formatNumber value="${cnt_600}" groupingUsed="true"/>)</a></li>
				...
				<div class="page-body">
								...
								<div class="form-control">
									<div class="opt_select">
									   <select name="schStatus" id="schStatus"  required>
											...
											<option value="B" <c:if test="${SCHVO.schStatus eq 'B'}">selected</c:if>>교환 신청</option>
											<option value="N" <c:if test="${SCHVO.schStatus eq 'N'}">selected</c:if>>교환 처리중</option>
											<option value="Y" <c:if test="${SCHVO.schStatus eq 'Y'}">selected</c:if>>교환 완료</option>
										</select>
					...
					<c:otherwise>				
						...
						<div class="form-group">
							<a href="${CTX}/mypage/order/orderDetail.do?orderCd=${list.orderCd}&orderMenu=mypage_exchange">
...
<%-- 								<div class="date">접수일 <strong>${list.orderDt}</strong></div> --%>
					...
					<div class="guidebox">
						<div class="guide-title">
							<h3 class="tit"><span class="i"><img src="${CTX}/images/${DEVICE}/common/ico_helper_alert.png" alt="" /></span> 교환단계 안내</h3>
						</div>
						<div class="cancel-guide">
							<ol>
								<li>
									<strong class="step"><img src="${CTX}/images/${DEVICE}/common/num_1.png" alt="1" /> 교환신청</strong>
									<ul class="bu-list">
										<li><span class="bu">-</span> 오 배송 및 불량 : 교환 배송비는 무료입니다.</li>
										<li>
											<span class="bu">-</span> 고객 변심 : 교환 배송비는 고객 부담입니다. <br/>
											2개 이상의 상품을 교환 신청 하실 경우, 상품하자나 오 배송 상품이 포함되어 있다면 당사가 배송비를 부담합니다.
										</li>
										<li>
											<span class="bu">-</span> 면역공방 지정 택배사를 통해 교환해주세요.
										</li>
									</ul>
								</li>
								<li>
								...
								<li>
									<strong class="step"><img src="${CTX}/images/${DEVICE}/common/num_3.png" alt="3" /> 교환상품 확인</strong>
									<ul class="bu-list">
										<li><span class="bu">-</span> 교환하신 상품에 이상이 있을 경우에는 교환처리가 되지 않을 수도 있습니다.</li>
									</ul>
								</li>
								<li>
									<strong class="step"><img src="${CTX}/images/${DEVICE}/common/num_4.png" alt="4" /> 교환처리(교환상품 재 발송) 완료</strong>
								</li>
							</ol>
						</div>
					</div>
