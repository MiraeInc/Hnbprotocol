...
<script type="text/javascript">
	...
	$(document).on("click",".check:not(#chkAll)",function(){
		if(!$(this).is(":checked")){
	...
	function goNext(){
		if(!$("input:checkbox[name='termsYn']").is(":checked")){
			alert("비회원 구매 이용약관에 동의해 주세요.");
			$("input:checkbox[name='termsYn']").focus();
			return false;
		}
		
		if(!$("input:checkbox[name='collectionAgreementYn']").is(":checked")){
			alert("비회원 구매 개인정보 수집 동의에 동의해 주세요.");
			$("input:checkbox[name='collectionAgreementYn']").focus();
			return false;
		}
...
<body>
		<form name="orderForm" id="orderForm" method="post" onsubmit="return false;">
			...
			<div class="content comm-order order-agreement">
				...
				<div class="page-body">
					...
					<div class="user-agreement">
						<div class="row">
							<div class="col col-10 col-1-offset">
								<div class="form-control">
									<span class="checkbox">
										<input type="checkbox" name="termsYn" id="termsYn" value="Y" class="check">
										<label for="termsYn" class="lbl">비회원 구매 이용약관 <span class="em2">(필수)</span></label>
									</span>
								</div>
							</div>
							<div class="col col-10 col-1-offset">
								<div class="term-box">
									<button class="term-btn" type="button"></button>
									<div class="term-wrap">
						...
						<div class="row">
							<div class="col col-10 col-1-offset">
								<div class="form-control">
									<span class="checkbox">
										<input type="checkbox" name="collectionAgreementYn" id="collectionAgreementYn" value="Y" class="check">
										<label for="collectionAgreementYn" class="lbl">비회원 구매 개인정보 수집 동의 <span class="em2">(필수)</span></label>
									</span>
								</div>
							</div>
							<div class="col col-10 col-1-offset">
										...
										<div class="terms">
											<div class="terms-row">
												...
												<div class="terms-body" style="width: 70%">
													...
													<p>콘텐츠 제공, 구매 및 요금 결제, 물품배송 또는 청구지 등 발송, 금융거래 본인 인증 및 금융 서비스, 접속 빈도 파악 또는 서비스 이용에 대한 통계</p>
												</div>
											</div>
											...
											<div class="terms-row">
												...
												<div class="terms-body" style="width: 70%">
													...
													<ul>
														<li>- 보존 항목 : 이름, 이메일 주소, 휴대폰번호, 주문기록</li>
						...
						<div class="row">
							<div class="col col-10 col-1-offset">
								<div class="form-control">
									<span class="checkbox">
										<input type="checkbox" name="consignmentAgreementYn" id="consignmentAgreementYn" value="Y" class="check">
										<label for="consignmentAgreementYn" class="lbl">비회원 구매 개인정보 취급 위탁 동의 <span class="em2">(선택)</span></label>
									</span>
								</div>
							</div>
							<div class="col col-10 col-1-offset">
								<div class="term-box">
									...
									<div class="term-wrap">
										<div class="terms">
											<div class="terms-row" style="display: none">
												<div class="terms-head">
													<p>취급 위탁 받는 자</p>
												</div>
												<div class="terms-head" style="width: 70%;">
													<p>취급위탁 업무내용</p>
												</div>
											</div>
							...
							<div class="col col-12">
								<div class="form-control" style="text-align: center;">
									<span class="checkbox">
										...
										<label for="chkAll" class="lbl">전체 동의</label>
									</span>
								</div>
							</div>
						</div>
						...
						<div class="btn-box confirm">
							<button type="button" class="btn black" onclick="javascript:goNext();"><span class="txt">다음</span></button>
						</div>
