...
<html>
<head>
<c:set var="layout_type" value="mamabutter" scope="request" />
...
<body>
	<div class="content comm-main">
		...
		<div class="main-category">
			<ul>
				<li class="cate-item">
					<a href="${CTX}/product/productList.do?schCateIdx=51&schCateFlag=ALL" class="cate-link">
						<div class="cate-ico"><img src="${CTX}/images/${DEVICE}/main/ico_mama_lotion.png" alt="" /></div>
						<p class="cate-name">로션/크림/오일</p>
					</a>
				</li>
				<li class="cate-item">
					<a href="${CTX}/product/productList.do?schGbn=&schCateIdx=58" class="cate-link">
						<div class="cate-ico"><img src="${CTX}/images/${DEVICE}/main/ico_mama_soap.png" alt="" /></div>
						<p class="cate-name">바디솝</p>
					</a>
				</li>
				<li class="cate-item">
					<a href="${CTX}/product/productList.do?schGbn=&schCateIdx=78" class="cate-link">
						<div class="cate-ico"><img src="${CTX}/images/${DEVICE}/main/ico_mama_maskpack.png" alt="" /></div>
						<p class="cate-name">마스크팩</p>
					</a>
				</li>
			</ul>
		</div>
		...
		<c:if test="${!empty saleList}">
			...
			<div class="product-items nobor">
				<ul class="type-default">
					<c:forEach var="list" items="${saleList}" varStatus="idx" end="7">
		...
		<c:if test="${!empty bestList}">
			<h2 class="title"><a href="${CTX}/product/bestProductList.do?gnbBrand=mamabutter&brandIdx=6">Mandom<br/>Best Product</a></h2>
...
<c:forEach var="list" items="${popupList}" varStatus="idx" end="0">
	<c:if test="${list.mamabutterYn eq '1'}">
