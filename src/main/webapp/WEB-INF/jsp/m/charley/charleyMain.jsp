...
<html>
<head>
<c:set var="layout_type" value="charley" scope="request" />
...
<body>
	<div class="content comm-main">
		...
		<div class="main-category">
			<ul>
				<li class="cate-item">
					<a href="${CTX}/product/productList.do?schCateIdx=55&schCateFlag=ALL" class="cate-link">
						<div class="cate-ico"><img src="${CTX}/images/${DEVICE}/main/ico_charley_bath.png" alt="" /></div>
						<p class="cate-name">입욕제</p>
					</a>
				</li>
			</ul>
		</div>
		...
		<c:if test="${!empty saleList}">
			<h2 class="nowsale-title">VIEW ALL</h2>
		...
		<c:if test="${!empty bestList}">
			<h2 class="title"><a href="${CTX}/product/bestProductList.do?gnbBrand=charley&brandIdx=8">Mandom<br/>Best Product</a></h2>
