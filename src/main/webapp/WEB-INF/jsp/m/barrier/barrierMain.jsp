...
<html>
<head>
<c:set var="layout_type" value="barrier" scope="request" />
...
<body>
	<div class="content">
		...
		<div class="main-category">
			<ul>
				<li class="cate-item">
					<a href="${CTX}/product/productList.do?schCateIdx=70&schCateFlag=ALL" class="cate-link">
						<div class="cate-ico"><img src="${CTX}/images/${DEVICE}/main/ico_barrier_maskpack.png" alt="" /></div>
						<p class="cate-name">마스크팩</p>
					</a>
				</li>				
				<li class="cate-item">
					<a href="${CTX}/product/productList.do?schCateIdx=82&schCateFlag=ALL" class="cate-link">
						<div class="cate-ico"><img src="${CTX}/images/${DEVICE}/main/ico_barrier_set.png" alt="" /></div>
