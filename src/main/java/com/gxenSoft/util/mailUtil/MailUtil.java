	...
	public static void sendMemberJoin(MemberVO vo)throws Exception{
		try{
			...
			if(vo.getJoinType().equals("1")){
				bf.append(vo.getMemberNm()+" 고객님께서는 <span style='color:#00aaad;'>"+vo.getSnsTypeNm()+"</span>(으)로 가입하셨습니다.</td>");
			}else{
				bf.append(vo.getMemberNm()+" 고객님께서 가입하신 ID는 <span style='color:#00aaad;'>"+vo.getMemberId()+"</span>입니다.</td>");
			}
			bf.append("</tr>");
			bf.append("<tr>");
...
//			bf.append("<span style=\"color:#00aaad;font-weight:bold;font-size:38px;vertical-align:middle;\">1</span> &nbsp;2,000P 지급 완료!");
//			bf.append("</td>");
//			bf.append("<td height='' style=\"text-align:center;vertical-align:top;font-family:'NanumSquare','나눔고딕',NanumGothic,'맑은고딕',Malgun Gothic,'돋움',Dotum,Helvetica,'Apple SD Gothic Neo',Sans-serif;letter-spacing:-1px;color:#444;font-size:19px;\">");
//			bf.append("<span style=\"color:#00aaad;font-weight:bold;font-size:38px;vertical-align:middle;\">2</span> &nbsp;무료배송 쿠폰 지급 완료!");
//			bf.append("</td>");
//			bf.append("</tr>");
			bf.append("<tr>");
			...
			bf.append("</tr>");
			bf.append("<tr>");
			bf.append("<td colspan='2' height='45' style=\"text-align:center;vertical-align:middle;font-family:'NanumSquare','나눔고딕',NanumGothic,'맑은고딕',Malgun Gothic,'돋움',Dotum,Helvetica,'Apple SD Gothic Neo',Sans-serif;letter-spacing:-1px;color:#00aaad;font-size:19px;\">");
	...
	public static void sendMemberPassword(MemberVO vo)throws Exception{
		try{
			...
			bf.append("<tr>");
			bf.append("<td height='' style=\"padding-left:20px;text-align:left;vertical-align:middle;font-family:'NanumSquare','나눔고딕',NanumGothic,'맑은고딕',Malgun Gothic,'돋움',Dotum,Helvetica,'Apple SD Gothic Neo',Sans-serif;letter-spacing:-1px;color:#00aaad;font-size:34px;font-weight:bold;\">");
			...
			bf.append("<tr>");
			bf.append("<td colspan='2' height='' style=\"text-align:center;vertical-align:middle;font-family:'NanumSquare','나눔고딕',NanumGothic,'맑은고딕',Malgun Gothic,'돋움',Dotum,Helvetica,'Apple SD Gothic Neo',Sans-serif;letter-spacing:-1px;color:#00aaad;font-size:19px;\">");
	...
	public static void sendOrderCardCompletEmail(SqlMap orderInfo,List<SqlMap> list)throws Exception{
		try{
			...
			bf.append(" 				</tr>");
			bf.append(" 				<tr>");
			bf.append(" 					<td colspan='2' height='' style=\"text-align:center;vertical-align:middle;font-family:'NanumSquare','나눔고딕',NanumGothic,'맑은고딕',Malgun Gothic,'돋움',Dotum,Helvetica,'Apple SD Gothic Neo',Sans-serif;color:#444;font-size:35px;font-weight: bold;\"><span style='color:#00aaad;'>주문이 완료</span>되었습니다.</td>");
			bf.append(" 				</tr>");
			bf.append(" 				<tr>");
			bf.append(" 					<td colspan='2' height='30'></td>");
			bf.append(" 				</tr>");
	...
	public static void sendOrderBankDepositCompletEmail(SqlMap orderInfo,List<SqlMap> list)throws Exception{
		try{
			...
			bf.append(" 				</tr>");
			bf.append(" 				<tr>");
			bf.append(" 					<td colspan='2' height='' style=\"text-align:center;vertical-align:middle;font-family:'NanumSquare','나눔고딕',NanumGothic,'맑은고딕',Malgun Gothic,'돋움',Dotum,Helvetica,'Apple SD Gothic Neo',Sans-serif;color:#444;font-size:35px;font-weight: bold;\"><span style='color:#00aaad;'>입금 확인이 완료</span>되었습니다.</td>");
			bf.append(" 				</tr>");
			bf.append(" 				<tr>");
			bf.append(" 					<td colspan='2' height='30'></td>");
			bf.append(" 				</tr>");
	...
	public static void sendOrderCancelEmail(SqlMap orderInfo,List<SqlMap> list)throws Exception{
		try{
			...
			bf.append(" 				</tr>");
			bf.append(" 				<tr>");
			bf.append(" 					<td colspan='2' height='' style=\"text-align:center;vertical-align:middle;font-family:'NanumSquare','나눔고딕',NanumGothic,'맑은고딕',Malgun Gothic,'돋움',Dotum,Helvetica,'Apple SD Gothic Neo',Sans-serif;color:#444;font-size:35px;font-weight: bold;\"><span style='color:#00aaad;'>주문이 취소</span>되었습니다.</td>");
			bf.append(" 				</tr>");
			bf.append(" 				<tr>");
			bf.append(" 					<td colspan='2' height='30'></td>");
			bf.append(" 				</tr>");
	...
	public static void sendOrderChangeEmail(SqlMap orderInfo,List<SqlMap> list)throws Exception{
		try{
			...
			bf.append(" 				</tr>");
			bf.append(" 				<tr>");
			bf.append(" 					<td colspan='2' height='' style=\"text-align:center;vertical-align:middle;font-family:'NanumSquare','나눔고딕',NanumGothic,'맑은고딕',Malgun Gothic,'돋움',Dotum,Helvetica,'Apple SD Gothic Neo',Sans-serif;color:#444;font-size:35px;font-weight: bold;\"><span style='color:#00aaad;'>교환신청이 접수</span>되었습니다.</td>");
			bf.append(" 				</tr>");
			bf.append(" 				<tr>");
			bf.append(" 					<td colspan='2' height='30'></td>");
			bf.append(" 				</tr>");
	...
	public static void sendOrderReturnEmail(SqlMap orderInfo,List<SqlMap> list)throws Exception{
		try{
			...
			bf.append(" 				</tr>");
			bf.append(" 				<tr>");
			bf.append(" 					<td colspan='2' height='' style=\"text-align:center;vertical-align:middle;font-family:'NanumSquare','나눔고딕',NanumGothic,'맑은고딕',Malgun Gothic,'돋움',Dotum,Helvetica,'Apple SD Gothic Neo',Sans-serif;color:#444;font-size:35px;font-weight: bold;\"><span style='color:#00aaad;'>반품신청이 접수</span>되었습니다.</td>");
			bf.append(" 				</tr>");
			bf.append(" 				<tr>");
			bf.append(" 					<td colspan='2' height='30'></td>");
			bf.append(" 				</tr>");
